    ...
    <div>
      ...
      <store-path data-path="data" view-state-path="viewState">
        <div class="root-store">
          ...
          <card-template :data-path="pathName" :view-state-path="pathName" />
        </div>
        <div class="module1-store">
          <card-template data-path="module1:modData.card3" view-state-path="module1:modViewState.card3" not-inherit-data-path not-inherit-view-state-path />
        </div>
        <div>
          <h3>store状態</h3>
