 ...
 * @remarks
 *
 * - StorePathMixin で設定される mData, mViewState のパス文字列を配列に変換する。
 ...
 * ```
 *
 * @param path mData, mViewState で指定されたパス要素
...
/**
 * 外部からStoreState値を設定するメソッドを利用する際のメソッド名
 * setStoreState と同一とする
 */
export const STATE_SET_METHOD_NAME = 'setStoreState';
